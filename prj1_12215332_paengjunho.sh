...
else if(average*10 == int(average*10)) {printf "%d %.1f\n",$1,average} 
else if(average*100 == int(average*100)) {printf "%d %.2f\n",$1,average} 
else if(average*1000 == int(average*1000)) {printf "%d %.3f\n",$1,average} 
else if(average*10000 == int(average*10000)) {printf "%d %.4f\n",$1,average} 
